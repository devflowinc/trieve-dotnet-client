...
namespace trieve_dotnet_client.Model
{
    ...
    /// SearchChunkData
    /// </summary>
    [DataContract(Name = "SearchChunkData")]
    public partial class SearchChunkData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchChunkData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SearchChunkData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchChunkData" /> class.
        /// </summary>
        ...
        public SearchChunkData(bool? dateBias = default(bool?), ChunkFilter filters = default(ChunkFilter), bool? getCollisions = default(bool?), List<string> highlightDelimiters = default(List<string>), bool? highlightResults = default(bool?), long? page = default(long?), long? pageSize = default(long?), string query = default(string), float? scoreThreshold = default(float?), string searchType = default(string), bool? useWeights = default(bool?))
        {
            // to ensure "query" is required (not null)
            if (query == null)
            {
                throw new ArgumentNullException("query is a required property for SearchChunkData and cannot be null");
            }
            this.Query = query;
            // to ensure "searchType" is required (not null)
            if (searchType == null)
            {
                throw new ArgumentNullException("searchType is a required property for SearchChunkData and cannot be null");
            }
