...
namespace trieve_dotnet_client.Model
{
    ...
    /// UpdateChunkData
    /// </summary>
    [DataContract(Name = "UpdateChunkData")]
    public partial class UpdateChunkData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateChunkData" /> class.
        /// </summary>
        ...
        /// <param name="chunkId">Id of the chunk you want to update. You can provide either the chunk_id or the tracking_id. If both are provided, the chunk_id will be used..</param>
        ...
        /// <param name="trackingId">Tracking_id of the chunk you want to update. This is required to match an existing chunk..</param>
        ...
        /// </summary>
        /// <value>Id of the chunk you want to update. You can provide either the chunk_id or the tracking_id. If both are provided, the chunk_id will be used.</value>
        [DataMember(Name = "chunk_id", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateChunkData {\n");
