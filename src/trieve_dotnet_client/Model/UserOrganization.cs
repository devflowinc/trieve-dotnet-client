...
namespace trieve_dotnet_client.Model
{
    ...
    public partial class UserOrganization : IValidatableObject
    {
        /// <summary>
        ...
        public UserOrganization(DateTime createdAt = default(DateTime), Guid id = default(Guid), Guid organizationId = default(Guid), int role = default(int), DateTime updatedAt = default(DateTime), Guid userId = default(Guid))
        {
